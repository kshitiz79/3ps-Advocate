    ...
    if (data?.success && data.data) {
      ...
      const filteredProduct = data.data.find(
        (product) =>
          ...
          "Request For Examination".toLowerCase().trim()
      );
  ...
  if (!pageData) {
    return (
      <p className="text-center text-gray-500 mt-10">
        No product data available for "Request For Examination".
      </p>
    );
  }
...
export default RequestforExamination