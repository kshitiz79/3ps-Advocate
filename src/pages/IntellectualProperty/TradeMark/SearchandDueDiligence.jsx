    ...
    if (data?.success && data.data) {
      ...
      const filteredProduct = data.data.find(
        (product) =>
          ...
          "Search and Due Diligence".toLowerCase().trim()
      );
  ...
  if (!pageData) {
    return (
      <p className="text-center text-gray-500 mt-10">
        No product data available for "Search and Due Diligence".
      </p>
    );
  }
...
export default SearchandDueDiligence