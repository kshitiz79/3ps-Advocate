    ...
    if (data?.success && data.data) {
      ...
      const filteredProduct = data.data.find(
        (product) =>
          ...
          "Increased Authorized Capital".toLowerCase().trim()
      );
  ...
  if (!pageData) {
    return (
      <p className="text-center text-gray-500 mt-10">
        No product data available for "Increased Authorized".
      </p>
    );
  }
...
export default IncreasedAuthorized;
